...
export default class ProductList extends React.Component {
    ...
    componentDidMount() {
        axios.get("https://ec2-3-89-196-32.compute-1.amazonaws.com/dashboard/api/read.php")
            .then(res => {
    ...
    handleSubmit = e => {
        ...
        if (ids.length > 0) {
            for (let i = 0; i < ids.length; i++) {
                axios.delete("https://ec2-3-89-196-32.compute-1.amazonaws.com/dashboard/api/delete.php", {
                    data: {
                        "id": ids[i]
                    }
                }).catch(error => console.log(error))
